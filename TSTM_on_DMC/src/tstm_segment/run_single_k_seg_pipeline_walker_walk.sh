#!/bin/bash
# Single-K segmentation pipeline for walker_walk (no RL):
...
#   CUDA_VISIBLE_DEVICES=0 K=1 bash src/tstm_segment/run_single_k_seg_pipeline_walker_walk.sh
#   CUDA_VISIBLE_DEVICES=1 K=2 bash src/tstm_segment/run_single_k_seg_pipeline_walker_walk.sh
#   CUDA_VISIBLE_DEVICES=2 K=4 bash src/tstm_segment/run_single_k_seg_pipeline_walker_walk.sh
#   CUDA_VISIBLE_DEVICES=3 K=8 bash src/tstm_segment/run_single_k_seg_pipeline_walker_walk.sh
...
echo "=========================================="
echo "TSTM K Ablation - Segmentation Pipeline (Single K)"
echo "=========================================="
