...
def parse_args():
    ...
    parser.add_argument("--eval_mode", default="both", type=str)

    # agent
    parser.add_argument("--algorithm", default="tstm", type=str)
    ...
    # PPO
    parser.add_argument("--rollout_length", default=2048, type=int)
    parser.add_argument("--ppo_lr", default=3e-4, type=float)
    parser.add_argument("--gae_lambda", default=0.95, type=float)
    parser.add_argument("--clip_eps", default=0.1, type=float)
    parser.add_argument("--ppo_epochs", default=4, type=int)
    parser.add_argument("--ppo_minibatch_size", default=256, type=int)
    ...
    # augmentation
    parser.add_argument('--augment', default='overlay', type=str, choices=['none', 'conv', 'overlay', 'splice'], 
                    help='Type of strong augmentation used in MaDi')
    ...
    parser.add_argument('--mask_type', default='soft', type=str, choices=['soft', 'hard', 'mixed'])
    parser.add_argument('--mask_threshold', default=0.5, type=float)
    parser.add_argument('--mask_threshold_type', default='fix', type=str, choices=['fix', 'avg', 'quantile'])

    # TSTM
    parser.add_argument("--policy_consistency_weight", default=2, type=float)
    parser.add_argument("--INV_loss_weight", default=1.0, type=float)
    parser.add_argument("--INV_lambda", default=1.25, type=float)
    parser.add_argument("--INV_mu", default=1.25, type=float)
    parser.add_argument("--INV_rho", default=0.005, type=float)
    parser.add_argument("--INV_gamma", default=1.0, type=float)
    parser.add_argument("--projector_hidden_dim", default=2048, type=int)
    parser.add_argument("--projector_output_dim", default=2048, type=int)
    parser.add_argument("--temporal_model_path", default="/your_path_to_temporal_model", type=str, help="Path to trained temporal segmentation model (SimpleCNN_ConvLSTM)")

    parser.add_argument("--temporal_mask_threshold", default=0.5, type=float)

    parser.add_argument("--temporal_mask_chunk_size", default=256, type=int)
    parser.add_argument("--temporal_mask_amp", default=1, type=int)
    ...
    if args.algorithm in {"ppo", "tstm_ppo"}:
        args.init_steps = 0
