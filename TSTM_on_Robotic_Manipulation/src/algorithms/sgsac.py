...
class SGSAC(SAC):
    def __init__(self, obs_shape, action_shape, args):
        ...
        self.quantile = args.sgsac_quantile
    ...
    #     grad_grid = make_obs_grad_grid(obs_grad.data.abs(), quantile=self.quantile)
    ...
    #     attrib_grid = make_obs_grad_grid(torch.sigmoid(attrib), quantile=self.quantile)
