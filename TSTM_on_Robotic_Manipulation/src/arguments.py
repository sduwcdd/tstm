...
def parse_args():
    ...
    parser.add_argument("--eval_mode", default="none", type=str)#Effective in dmc, ineffective in robot_env, legacy code
    parser.add_argument(
    ...
    # eval
    parser.add_argument("--save_freq", default="125k", type=str)
